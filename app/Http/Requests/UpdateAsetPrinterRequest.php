...
class UpdateAsetPrinterRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $detailId = $aset?->printer?->id;

        return [
            'nomor_seri' => ['required', 'string', 'max:100', Rule::unique('aset_printer', 'nomor_seri')->ignore($detailId)],
