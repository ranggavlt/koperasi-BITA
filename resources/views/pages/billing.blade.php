              ...
              <div class="max-w-full px-3 mb-4 lg:mb-0 lg:w-full lg:flex-none">
                <div
                  ...
                  <div class="flex-auto p-4">
                    <div class="flex flex-wrap -mx-3">
                      <div
                        class="max-w-full px-3 mb-6 md:mb-0 md:w-1/2 md:flex-none">
                        <div
                  ...
                  <li
                    ...
                    <div class="ml-auto text-right">
                      <a
                        ...
                        href="javascript:;"
                        ><i
                          class="mr-2 far fa-trash-alt bg-150 bg-gradient-to-tl from-red-600 to-rose-400 bg-x-25 bg-clip-text"></i
                        >Delete</a
                      >
                      <a
