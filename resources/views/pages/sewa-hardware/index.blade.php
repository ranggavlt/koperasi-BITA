            ...
            <tr>
              ...
              <td>
                <div class="kbsm-business-inline-actions">
                  ...
                  @if($item->status === 'dikonfirmasi' && !$item->pembayaranVendor && !$item->pembayaran)
                    <form method="POST" action="{{ route('sewa-hardware.pay-vendor', $item) }}" class="kbsm-business-inline-row">
                      @csrf
