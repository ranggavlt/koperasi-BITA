...
<html lang="en">
  ...
  <body class="kbsm-app m-0 font-sans text-base antialiased font-normal leading-default bg-gray-50 text-slate-500">
    ...
    <main class="kbsm-layout-main ease-soft-in-out relative min-h-screen rounded-xl transition-all duration-200">
    ...
    <script src="{{ asset('assets/js/soft-ui-dashboard-tailwind.js') }}?v=20260803" defer></script>
