...
<aside
  ...
  <div class="items-center block w-auto max-h-screen h-sidenav grow basis-full">
    <ul class="flex flex-col pl-0 mb-0">
          ...
          <div class="{{ $active
            ...
            <svg
              ...
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                {{-- ini yang penting: ganti fill jadi currentColor --}}
      ...
      {{-- BILLING --}}
      @php $active = $is('pages.billing'); @endphp
      <li class="mt-0.5 w-full">
        <a class="{{ $linkClass($active) }}" href="{{ route('pages.billing') }}">
          <div class="{{ $active ? 'bg-gradient-to-tl from-purple-700 to-pink-500 shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center fill-current stroke-0 text-center xl:p-2.5'
      ...
      {{-- VIRTUAL REALITY --}}
      @php $active = $is('pages.virtual'); @endphp
      <li class="mt-0.5 w-full">
        <a class="{{ $linkClass($active) }}" href="{{ route('pages.virtual') }}">
          <div class="{{ $active ? 'bg-gradient-to-tl from-purple-700 to-pink-500 shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5'
                                 : 'shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5' }}">
            {{-- svg VR kamu --}}
            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                ...
                <g transform="translate(-2319.000000, -291.000000)" fill="#FFFFFF" fill-rule="nonzero">
                  <g transform="translate(1716.000000, 291.000000)">
                    <g transform="translate(603.000000, 0.000000)">
                      ...
                      <path class="fill-slate-800 opacity-60"
                            d="M20.4472136,21.5347318 L1.4472136,12.0347318 C0.953235098,11.7877425 0.352562058,11.9879669 0.105572809,12.4819454 C0.0361450918,12.6208008 0,12.7739139 0,12.929159 L0,30.1875 C0,30.6849375 0.280875,31.1390625 0.7258125,31.3621875 L19.5528096,40.7750766 C20.0467945,41.0220531 20.6474623,40.8218132 20.8944388,40.3278283 C20.963859,40.1889789 21,40.0358742 21,39.8806379 L21,22.429159 C21,22.0503869 20.7859976,21.7041238 20.4472136,21.5347318 Z"></path>
                    </g>
                  </g>
                </g>
              </g>
      ...
      {{-- RTL --}}
      @php $active = $is('pages.rtl'); @endphp
      <li class="mt-0.5 w-full">
        <a class="{{ $linkClass($active) }}" href="{{ route('pages.rtl') }}">
          <div class="{{ $active ? 'bg-gradient-to-tl from-purple-700 to-pink-500 shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5'
                                 : 'shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5' }}">
            {{-- svg rtl kamu --}}
                ...
                <g transform="translate(-2020.000000, -442.000000)" fill="#FFFFFF" fill-rule="nonzero">
                  <g transform="translate(1716.000000, 291.000000)">
                    <g transform="translate(304.000000, 151.000000)">
                      ...
                      <path class="fill-slate-800 opacity-60"
                            d="M31.5666667,23.2333333 C31.0516667,23.2933333 30.53,23.3333333 30,23.3333333 C29.4916667,23.3333333 28.9866667,23.3033333 28.48,23.245 L22.4116667,30.7433333 L29.9416667,38.2733333 C32.2433333,40.575 35.9733333,40.575 38.275,38.2733333 C40.5766667,35.9716667 40.5766667,32.2416667 38.275,29.94 L31.5666667,23.2333333 Z"></path>
                      <path class="fill-slate-800"
      ...
      {{-- SIGN IN --}}
      @php $active = $is('auth.signin'); @endphp
      <li class="mt-0.5 w-full">
        <a class="{{ $linkClass($active) }}" href="{{ route('auth.signin') }}">
          <div class="{{ $active ? 'bg-gradient-to-tl from-purple-700 to-pink-500 shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5'
                                 : 'shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5' }}">
            {{-- svg sign in kamu --}}
      ...
      {{-- SIGN UP --}}
      @php $active = $is('auth.signup'); @endphp
      <li class="mt-0.5 w-full">
        <a class="{{ $linkClass($active) }}" href="{{ route('auth.signup') }}">
          <div class="{{ $active ? 'bg-gradient-to-tl from-purple-700 to-pink-500 shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5'
                                 : 'shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5' }}">
            {{-- svg sign up kamu --}}
