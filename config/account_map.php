...
return [
    ...
    */
    'accounts' => [
        ...
        'utang_shu_anggota' => [
            'kode_akun' => '211',
            'nama_akun' => 'Utang SHU Anggota',
            'kategori' => 'kewajiban',
            'posisi_saldo' => 'kredit',
            'keterangan' => 'Hak SHU anggota yang telah ditetapkan dan belum dibayarkan.',
        ],
        'utang_shu_pengurus' => [
            'kode_akun' => '212',
            'nama_akun' => 'Utang SHU Pengurus',
            'kategori' => 'kewajiban',
            'posisi_saldo' => 'kredit',
            'keterangan' => 'Hak SHU pengurus yang telah ditetapkan dan belum dibayarkan.',
        ],
        'utang_shu_pengawas' => [
            'kode_akun' => '213',
            'nama_akun' => 'Utang SHU Pengawas',
            'kategori' => 'kewajiban',
            'posisi_saldo' => 'kredit',
            'keterangan' => 'Hak SHU pengawas yang telah ditetapkan dan belum dibayarkan.',
        ],
        'utang_shu_pembina' => [
            'kode_akun' => '214',
            'nama_akun' => 'Utang SHU Pembina',
            'kategori' => 'kewajiban',
            'posisi_saldo' => 'kredit',
            'keterangan' => 'Hak SHU pembina yang telah ditetapkan dan belum dibayarkan.',
        ],
        'dana_pendidikan' => [
            'kode_akun' => '215',
            'nama_akun' => 'Dana Pendidikan Tersedia',
            'kategori' => 'kewajiban',
            'posisi_saldo' => 'kredit',
            'keterangan' => 'Alokasi pendidikan yang telah ditetapkan dan belum digunakan.',
        ],
